...
exports.default = function (target) {
    ...
    try {
        for (var _iterator = sources[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var propDescriptors = Object.getOwnPropertyDescriptors(source);
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;

            try {
                for (var _iterator2 = Reflect.ownKeys(propDescriptors)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
exports.InvalidInstanceException = exports.InvalidSchemaException = undefined;
...
var InvalidSchemaException = exports.InvalidSchemaException = function (_extendableBuiltin2) {
    _inherits(InvalidSchemaException, _extendableBuiltin2);

    function InvalidSchemaException(reason) {
        _classCallCheck(this, InvalidSchemaException);

        return _possibleConstructorReturn(this, (InvalidSchemaException.__proto__ || Object.getPrototypeOf(InvalidSchemaException)).call(this, 'Invalid schema: ' + reason));
    }

    return InvalidSchemaException;
}(_extendableBuiltin(Error));

var InvalidInstanceException = exports.InvalidInstanceException = function (_extendableBuiltin4) {
    _inherits(InvalidInstanceException, _extendableBuiltin4);

    function InvalidInstanceException(reason, value) {
        _classCallCheck(this, InvalidInstanceException);

        return _possibleConstructorReturn(this, (InvalidInstanceException.__proto__ || Object.getPrototypeOf(InvalidInstanceException)).call(this, 'Failed to construct instance: ' + reason + ', given \'' + JSON.stringify(value) + '\''));
    }
...
var interpret = function interpret(schema, value) {
    ...
    if (schema === undefined) {
        ...
        var missingProperties = _lodash2.default.difference(Object.getOwnPropertyNames(schema), Object.getOwnPropertyNames(value));

        if (missingProperties.length > 0) {
            var missingPropNames = missingProperties.map(function (prop) {
                return '\'' + prop + '\'';
            }).join(', ');
        ...
        interpretedValue = _lodash2.default.mapValues(schema, function (schemaProp, propName) {
            return interpret(schemaProp, value[propName]);
        });
    } else if (_lodash2.default.isArray(schema) && schema.length === 1) {
        ...
        interpretedValue = value.map(function (element, index) {
            return interpret(elementSchema, element);
        });
    } else if (_lodash2.default.isFunction(schema)) {
...
var _internalValue = Symbol('internal-value');
...
var constructor = function constructor() {
    ...
    var Constructor = function Constructor() {
        ...
        var instance = interpret(schema, value);
    ...
    Constructor.constrain = function (fn) {
        constrain = fn;return Constructor;
    };

    // Extend this constructor with the given additional properties
    Constructor.extend = function (props) {
        (0, _assign2.default)(Constructor.prototype, props);
